...
-- 1. Fix jobs table - hide employer_email from public view
...
-- 2. Fix resumes table - restrict PII access
...
-- 3. Add better rate limiting table with proper constraints
...
('security_policy_update', '{"changes": ["jobs_email_hidden", "resumes_pii_restricted", "rate_limit_enhanced"]}');
